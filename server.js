...
const EMBEDDED_FILE = path.join(__dirname, 'data_embedded2.json');
// Nouveau lien direct Google Drive
const REMOTE_URL = 'https://drive.google.com/uc?export=download&id=1TpEPy9m_d2plDbx3PRV5oGxN7McTR0e4';
